<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AgendaList.aspx.cs" Inherits="Consultorio.PanelConsultas.AgendaList" MasterPageFile="~/mConsultorio.Master"   UICulture="es" Culture="es-AR" %>
                            ...
                            <ItemTemplate>
                                ...
                                <asp:BoundField DataField="hFin" HeaderText="Fin" >
                                    <ItemStyle Width="5%" HorizontalAlign="Center" />
                                      ...
                                      <asp:BoundField ItemStyle-Width="20px"  DataField="cantidadTurnos" HeaderText="Generados" ItemStyle-BackColor="#CCCCCC" ItemStyle-ForeColor="#CC3300" ItemStyle-Font-Size="12" ItemStyle-Font-Bold="True" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center" BackColor=LightGray Font-Bold="True" Font-Size="10pt" ForeColor="Black" Width="5%"></ItemStyle>
                                </asp:BoundField>
                                
                                 <asp:BoundField ItemStyle-Width="20px"   DataField="CantidadBloqueado" HeaderText="Bloqueados" ItemStyle-BackColor="#CCCCCC" ItemStyle-ForeColor="#CC3300" ItemStyle-Font-Size="12" ItemStyle-Font-Bold="True" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center" BackColor=LightGray Font-Bold="True" Font-Size="10pt" ForeColor="#CC3300" 
                                           Width="5%"></ItemStyle>
                                </asp:BoundField>
                                
                                  <%-- <asp:BoundField ItemStyle-Width="20px"   DataField="TurnosDisponibles" HeaderText="Disponibles" ItemStyle-BackColor="#CCCCCC" ItemStyle-ForeColor="#CC3300" ItemStyle-Font-Size="12" ItemStyle-Font-Bold="True" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center" BackColor=LightGray Font-Bold="True" Font-Size="10pt" ForeColor="#CC3300" 
                                           Width="5%"></ItemStyle>
                                </asp:BoundField>--%>
                                
                                     <asp:BoundField  ItemStyle-Width="20px" DataField="turnosAnticipados" HeaderText="Dados Anticip." ItemStyle-BackColor="#CCCCCC" ItemStyle-ForeColor="#CC3300" ItemStyle-Font-Size="12" ItemStyle-Font-Bold="True" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center" BackColor=LightYellow Font-Bold="True" Font-Size="10pt" ForeColor="#CC3300" 
                                        Width="5%"></ItemStyle>
                                </asp:BoundField>
                                
                                <asp:BoundField  ItemStyle-Width="20px" DataField="turnosDia" HeaderText="Dados Dia" ItemStyle-BackColor="#CCCCCC" ItemStyle-ForeColor="#CC3300" ItemStyle-Font-Size="12" ItemStyle-Font-Bold="True" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center" BackColor=LightYellow Font-Bold="True" Font-Size="10pt" ForeColor="#CC3300" 
                                        Width="5%"></ItemStyle>
                                </asp:BoundField>
...
<ItemStyle HorizontalAlign="Center" BackColor=LightYellow Font-Bold="True" Font-Size="10pt" ForeColor="#CC3300" 
                                   ...
                                   <asp:BoundField ItemStyle-Width="20px"   DataField="turnosDisponibles" HeaderText="Turnos Disponibles" ItemStyle-BackColor="#CCCCCC" ItemStyle-ForeColor="#CC3300" ItemStyle-Font-Size="12" ItemStyle-Font-Bold="True" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center" BackColor=LightCyan Font-Bold="True" Font-Size="10pt" ForeColor="#CC3300" 
                                           Width="5%"></ItemStyle>
                                </asp:BoundField>
                                   <asp:BoundField ItemStyle-Width="20px"   DataField="sobreturnos" HeaderText="Sobre Turnos" ItemStyle-BackColor="#CCCCCC" ItemStyle-ForeColor="#CC3300" ItemStyle-Font-Size="12" ItemStyle-Font-Bold="True" ItemStyle-HorizontalAlign="Center">
<ItemStyle HorizontalAlign="Center" BackColor=LightYellow Font-Bold="True" Font-Size="10pt" ForeColor="#CC3300" 
                                           Width="5%"></ItemStyle>
                                </asp:BoundField>
                                ...
                                <asp:TemplateField HeaderText="Planilla" Visible="False" >
                                  <ItemTemplate >
                                ...
                                <asp:TemplateField HeaderText="Codificar" Visible="False" >
                                  <ItemTemplate >
                                  ...
                                  <ItemTemplate >
                                    <asp:LinkButton  ID="Abrir" Text="Abrir" CommandName="Abrir" runat="server" AlternateText="Seleccionar"  OnClientClick="return PreguntoEliminar();" />
                                  </ItemTemplate>
                                    <ItemStyle Width="5%" HorizontalAlign="Center" />
                                </asp:TemplateField>
    ...
    {
    if (confirm('¿Está seguro de abrir la agenda?'))
    return true;
    else
    return false;
    }
