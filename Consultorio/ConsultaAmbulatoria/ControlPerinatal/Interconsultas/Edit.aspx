<%@ Page Title="" Language="C#" MasterPageFile="~/ConsultaAmbulatoria/MasterPages/ConsultorioPerinatal.Master"
    Theme="apr" AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="Consultorio.ConsultaAmbulatoria.ControlPerinatal.Interconsultas.Edit" %>
    ...
    <table class="formulario">
        ...
        <tr>
            <td colspan="2">
                ...
                <asp:TextBox runat="server" ID="txtObservacion" TextMode="MultiLine" Rows="3" CssClass="form-control"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td colspan="2">
                <asp:Label runat="server" ID="lProfesional" Text="Profesional de Interconsulta" AssociatedControlID="ddlProfesional"></asp:Label>
