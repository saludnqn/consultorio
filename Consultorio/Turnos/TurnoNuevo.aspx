<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="TurnoNuevo.aspx.cs" Inherits="Consultorio.Turnos.TurnoNuevo"
        ...
        <tr>
            <td>
                <table width="800px">
                    ...
                    <tr>
                        <td class="myLabelIzquierda" width="200px" align="left">Nro. DNI:
                        </td>
                        ...
                        <td align="myLabelIzquierda" width="70px">HC:
                        </td>
                        ...
                        <td colspan="4">
                            <asp:Label ID="lblMensaje" runat="server" Text="" style="color: rgb(255, 0, 0); font-size: 0.94em; visibility: visible;"></asp:Label>
                            <asp:Label ID="lblMensajeOK" runat="server" Text="" style="color: black; font-size: 0.94em; visibility: visible;"></asp:Label>
                        </td>
                    </tr>                    
                    <tr>
                        <td class="myLabelIzquierda" width="200px" align="left" style="vertical-align: top">Obra Social:&nbsp;
                        </td>
                    ...
                    <ContentTemplate>
                        <div id="tabs" style="width: 100%; height: 700px;">
                            ...
                            <div id="tab1" style="width: 95%; height: 500px; overflow: auto; left: -20px;">
                                <h1 class="myLabelIzquierda">Turnos dados a partir de hoy</h1>
                            ...
                            <div id="tab2" style="width: 90%; height: 500px; overflow: auto;">
                                <h1 class="myLabelIzquierda">Turnos anteriores al día de hoy</h1>
                            ...
                            <asp:LinkButton ID="btnGrabarRechazo" CssClass="myLink" OnClick="btnGrabarRechazo_Click" runat="server">Registrar Demanda Rechazada</asp:LinkButton>--%>
                                                                            ...
                                                                            <td colspan="2" align="left" class="myLabelIzquierda"></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td align="right" class="myLabelIzquierda">Especialidad:
                                                                            </td>
                                                                            <td align="left">
                                                                        ...
                                                                        <tr>
                                                                            <td align="right" class="myLabelIzquierda">Desde:
                                                                            </td>
                                                                            <td class="myLabelIzquierda" align="left">
                                                                            ...
                                                                            <td align="right" class="myLabelIzquierda">Hasta:
                                                                            </td>
                                                                            <td align="left">
                                            ...
                                            <tr>
                                                <td id="celdaagendas" class="modalPanel" style="vertical-align: top; width: 100%; height: 500px;">
                                                    <table>
                                                        <tr>
                                                            <td style="vertical-align: top;">
                                                                        ...
                                                                        <div id="divfechas" runat="server" visible="false">
                                                                            <div id="divfechasok" style="height: 50px;" runat="server" visible="false">
                                                                                ...
                                                                                <div id="datosagenda" align="center">
                                                                                    <h1 class="myLabelRojo">Fechas disponibles: &nbsp;
                                                                            ...
                                                                            <div id="div1" style="height: 400px; width: 350px; overflow: auto;">
                                                                                <asp:GridView ID="gvFechas" runat="server" AllowPaging="False" AutoGenerateColumns="False"
                                                                                    ...
                                                                                    <Columns>
                                                                                        <asp:TemplateField HeaderText="Profesionales" ItemStyle-Width="350px" HeaderStyle-Width="200px">
                                                                                            <ItemTemplate>
                                                                                      ...
                                                                                      <asp:TemplateField HeaderText="Especialidad" ItemStyle-Width="350px" HeaderStyle-Width="200px">
                                                                                            <ItemTemplate>
                                                                                    ...
                                                                                    <AlternatingRowStyle BackColor="#CCCCCC" Font-Italic="true" ForeColor="DarkBlue" />
                                                                                </asp:GridView>
                                                                            </div>
                                                                        </div>
                                                                ...
                                                                <asp:UpdatePanel ID="updgrilla" runat="server" Visible="true">
                                                                    <ContentTemplate>
                                                                        <div>
                                                                            ...
                                                                            <div id="divscroll" style="width: 600px; border: 1px ridge #C0C0C0; height: 380px; overflow: auto; float: left">
                            ...
                            <div style="float:left; text-align:left; width:300px;">
                              <b class="labelerror" style="font-weight:bolder;">Debe seleccionar un servicio</b>
                                ...
                                <table style="width: 100%;" align="left">
                                    <tr>
                                        <td class="mytituloPagina" colspan="3">Nuevo registro de demanda rechazada &nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        <td class="myLabelIzquierda" align="left" style="vertical-align: top">Especialidad:
                                        </td>
                                        <td>&nbsp;
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        <td class="myLabelIzquierda" align="left" style="vertical-align: top">Motivo:
                                        </td>
                                        <td>&nbsp;
                                        </td>
                                        <td align="left">
                                    ...
                                    <tr>
                                        <td class="myLabelIzquierda" align="left" style="vertical-align: top">Observaciones:
                                        </td>
                                        <td>&nbsp;
                                        </td>
                                        <td align="left">
