...
{
    public partial class PlotPerCefEdad : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, EventArgs e)
        {

        }
        public void Plot(SysPaciente oPaciente, ArrayList alPerCefalicoData, ArrayList alVisitas)
        {
            ...
            if (oEdad.Years >= 2)
            {
                ...
                oTabla = SPs.AprGetPercentilesPerimetroCefalicoEdadMas24meses(2).GetDataSet().Tables[0];
                xAxis = "Edad en años";
                Titulo = "Perimetro Céfalico / Edad 0 a 5 años";
            }
            else
            {
                //Muestro la grafica hasta 24 meses
                oTabla = SPs.AprGetPercentilesPerimetroCefalicoEdadHasta24meses(2).GetDataSet().Tables[0];
                xAxis = "Edad en meses";
                Titulo = "Perimetro Céfalico / Edad 0 a 24 meses";
            }
            ...
            if (alPerCefalicoData.Count > 0)
            {
                //Agrego la linea de perimetro cefalico
                LinePlot lpPerCefalico = new LinePlot();
                lpPerCefalico.Label = "Per. cefalico / Edad";
                lpPerCefalico.OrdinateData = alPerCefalicoData;
                lpPerCefalico.AbscissaData = alVisitas;
                lpPerCefalico.Color = Color.Black;
                lpPerCefalico.Pen.Width = 2.0f;
                //lpPerc97.Pen.DashStyle = DashStyle.Dash;
                plotSurface.Add(lpPerCefalico);
            }
            ...
            plotSurface.YAxis1.Label = "Per. céfalico (cm.)";
