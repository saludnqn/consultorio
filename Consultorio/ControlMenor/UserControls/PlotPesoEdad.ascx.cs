...
{
    public partial class PlotPesoEdad : System.Web.UI.UserControl
    {
        ...
        public void Plot(SysPaciente oPaciente, ArrayList alPeso, ArrayList alVisitas)
        {
            ...
            if (oEdad.Years >= 2)
            {
                ...
                oTabla = SPs.AprGetPercentilesPesoEdadMas24meses(2).GetDataSet().Tables[0];
                xAxis = "Edad en años";
                Titulo = "Peso / Edad 0 a 5 años";
            }
            else
            {
                //Muestro la grafica hasta 24 meses
                oTabla = SPs.AprGetPercentilesPesoEdadHasta24meses(2).GetDataSet().Tables[0];
                xAxis = "Edad en meses";
                Titulo = "Peso / Edad 0 a 24 meses";
            }
            ...
            if (alPeso.Count > 0)
            {
                //Agrego la linea de peso
                LinePlot lpPeso = new LinePlot();
                lpPeso.Label = "Peso / Edad";
                lpPeso.OrdinateData = alPeso;
                lpPeso.AbscissaData = alVisitas;
                lpPeso.Color = Color.Black;
                lpPeso.Pen.Width = 2.0f;
                //lpPerc97.Pen.DashStyle = DashStyle.Dash;
                plotSurface.Add(lpPeso);
            }
            ...
            plotSurface.YAxis1.Label = "Peso (kg.)";
