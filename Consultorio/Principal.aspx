...
<br />
  ...
  <h3><img src="../App_Themes/consultorio/images/information.png" /> 08/09/2015. Se ha actualizado el sistema con la opción de crear agendas mutidisciplinarias.</h3>
  <table>
    <tr>
      <td>
...
<br />
  ...
  <table width="600px" style="vertical-align: top" >
    ...
    <tr>
      <td class="myLabelTitulo" colspan="2">
          Bienvenido al Panel de Información del Sistema de Agendas y Turnos</td>
    </tr>
    <tr>
      <td  colspan="2">
              &nbsp;</td>
    ...
    <tr>
        <td>
            Cantidad de agendas abiertas y disponibilidad de turnos por efector.</td>
    </tr>
    ...
    <%--  <tr>
          <td class="style3" rowspan="2">
              &nbsp;<img src="../App_Themes/consultorio/images/indicador.gif" /></td>
          <td class="style4">
              <a href="PanelConsultas/TurnosxEfector.aspx"><b class="mySubTitulo">Turnos.</b></a>
          </td>
      </tr>
    
    
     <tr>
    <td >Cantidad de turnos generados, dados y disponibles por efector.<hr />
    </td>
    </tr>--%>
   ...
   <tr>
    ...
    <tr>
        <td>
            Informe de Cantidad de Diagnósticos CIE10, por efector, grupos etáreos y por sexo.</td>
    </tr>
   ...
   <%--  <tr>
    ...
    <td class="style5">&nbsp;</td>
     ...
     <tr>
    <td class="style5"><a  href="PanelConsultas/ReporteC2.aspx"><b class="mySubTitulo">
        Reporte Diagnósticos C2.</b></a></td>
    </tr>
     ...
     <img src="../App_Themes/consultorio/images/pdf.jpg"  /> 
       <asp:LinkButton ID="LinkButton1" runat="server" 
          onclick="LinkButton1_Click">Notificación de Uso del Sistema</asp:LinkButton>
                     ...
                     <br />
                       <img src="../App_Themes/consultorio/images/pdf.jpg"  /> 
       <asp:LinkButton ID="lnkPlanillaConsultaAmbulatoria" runat="server" onclick="lnkPlanillaConsultaAmbulatoria_Click" 
         >Modelo Planilla Consulta Ambulatoria</asp:LinkButton>
       <br />
       <img src="../App_Themes/consultorio/images/pdf.jpg"  /> 
       <asp:LinkButton ID="lnkPlanillaSaludMental" runat="server" onclick="lnkPlanillaSaludMental_Click" 
         >Modelo Planilla Salud Mental</asp:LinkButton>
       <br />
      <img src="../App_Themes/consultorio/images/pdf.jpg"  /> 
       <asp:LinkButton ID="lnkPlanillaOdontologia" runat="server" onclick="lnkPlanillaOdontologia_Click" 
         >Modelo Planilla Odontología</asp:LinkButton>
       <br />
