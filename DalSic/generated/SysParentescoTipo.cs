...
namespace DalSic
{
	...
	public partial class SysParentescoTipo : ActiveRecord<SysParentescoTipo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_ParentescoTipo", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("Sys_ParentescoTipo",schema);
			}
		}
		#endregion
