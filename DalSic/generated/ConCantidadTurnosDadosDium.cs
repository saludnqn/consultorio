...
namespace DalSic{
    ...
    public partial class ConCantidadTurnosDadosDium : ReadOnlyRecord<ConCantidadTurnosDadosDium>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadTurnosDadosDia", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_CantidadTurnosDadosDia",schema);
            }
        }
        #endregion
