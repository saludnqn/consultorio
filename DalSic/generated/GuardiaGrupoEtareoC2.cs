...
namespace DalSic{
    /// <summary>
    /// Strongly-typed collection for the GuardiaGrupoEtareoC2 class.
    /// </summary>
    [Serializable]
    public partial class GuardiaGrupoEtareoC2Collection : ReadOnlyList<GuardiaGrupoEtareoC2, GuardiaGrupoEtareoC2Collection>
    {        
        public GuardiaGrupoEtareoC2Collection() {}
    }
    /// <summary>
    /// This is  Read-only wrapper class for the GUARDIA_GrupoEtareoC2 view.
    /// </summary>
    [Serializable]
    public partial class GuardiaGrupoEtareoC2 : ReadOnlyRecord<GuardiaGrupoEtareoC2>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("GUARDIA_GrupoEtareoC2", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("GUARDIA_GrupoEtareoC2",schema);
            }
        }
        #endregion
	    ...
	    #region .ctors
	    public GuardiaGrupoEtareoC2()
	    {
            SetSQLProps();
            SetDefaults();
            MarkNew();
        }
        public GuardiaGrupoEtareoC2(bool useDatabaseDefaults)
	    {
		    SetSQLProps();
	    ...
	    public GuardiaGrupoEtareoC2(object keyID)
	    {
		    SetSQLProps();
		    LoadByKey(keyID);
	    }
    	 
	    public GuardiaGrupoEtareoC2(string columnName, object columnValue)
        {
            SetSQLProps();
        ...
        public string FechaIngreso 
	    {
		    get
		    {
			    return GetColumnValue<string>("fechaIngreso");
		    }
            set 
		    {
			    SetColumnValue("fechaIngreso", value);
            }
        }
