...
namespace DalSic
{
	...
	public partial class TamDiagnostico : ActiveRecord<TamDiagnostico>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("TAM_Diagnostico", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("TAM_Diagnostico",schema);
			}
		}
		#endregion
