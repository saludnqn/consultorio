...
namespace DalSic
{
	...
	public partial class AprDiagnosticoControlOdontologico : ActiveRecord<AprDiagnosticoControlOdontologico>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_DiagnosticoControlOdontologico", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_DiagnosticoControlOdontologico",schema);
			}
		}
		#endregion
		...
		public DalSic.AprControlNiñoSanoOdontologicoCollection AprControlNiñoSanoOdontologicoRecords
		{
			get
			{
				...
				{
					colAprControlNiñoSanoOdontologicoRecords = new DalSic.AprControlNiñoSanoOdontologicoCollection().Where(AprControlNiñoSanoOdontologico.Columns.IdDiagnosticoControlOdontologico, IdDiagnosticoControlOdontologico).Load();
