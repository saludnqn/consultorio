...
namespace DalSic
{
	...
	public partial class AprInicioEmbarazo : ActiveRecord<AprInicioEmbarazo>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_InicioEmbarazo", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_InicioEmbarazo",schema);
			}
		}
		#endregion
