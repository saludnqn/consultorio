...
namespace DalSic
{
	...
	public partial class PnResponsable : ActiveRecord<PnResponsable>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PN_responsables", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("PN_responsables",schema);
			}
		}
		#endregion
