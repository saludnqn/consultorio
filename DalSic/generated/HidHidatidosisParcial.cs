...
namespace DalSic
{
	...
	public partial class HidHidatidosisParcial : ActiveRecord<HidHidatidosisParcial>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Hid_HidatidosisParcial", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("Hid_HidatidosisParcial",schema);
			}
		}
		#endregion
