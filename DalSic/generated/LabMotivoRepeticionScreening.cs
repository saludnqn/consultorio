...
namespace DalSic
{
	...
	public partial class LabMotivoRepeticionScreening : ActiveRecord<LabMotivoRepeticionScreening>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("LAB_MotivoRepeticionScreening", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("LAB_MotivoRepeticionScreening",schema);
			}
		}
		#endregion
		...
		public DalSic.LabSolicitudScreeningRepeticionCollection LabSolicitudScreeningRepeticionRecords
		{
			get
			{
				...
				{
					colLabSolicitudScreeningRepeticionRecords = new DalSic.LabSolicitudScreeningRepeticionCollection().Where(LabSolicitudScreeningRepeticion.Columns.IdMotivoRepeticion, IdMotivoRepeticionScreening).Load();
