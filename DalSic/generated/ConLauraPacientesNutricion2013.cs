...
namespace DalSic{
    ...
    public partial class ConLauraPacientesNutricion2013 : ReadOnlyRecord<ConLauraPacientesNutricion2013>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_laura_pacientesNutricion2013", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_laura_pacientesNutricion2013",schema);
            }
        }
        #endregion
