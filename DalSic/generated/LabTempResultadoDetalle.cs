...
namespace DalSic
{
	...
	public partial class LabTempResultadoDetalle : ActiveRecord<LabTempResultadoDetalle>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("LAB_Temp_ResultadoDetalle", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("LAB_Temp_ResultadoDetalle",schema);
			}
		}
		#endregion
