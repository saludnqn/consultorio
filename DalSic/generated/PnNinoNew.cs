...
namespace DalSic
{
	...
	public partial class PnNinoNew : ActiveRecord<PnNinoNew>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PN_nino_new", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("PN_nino_new",schema);
			}
		}
		#endregion
