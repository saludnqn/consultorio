...
namespace DalSic
{
	...
	public partial class AprControlNiñoSanoConsultorio : ActiveRecord<AprControlNiñoSanoConsultorio>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ControlNiñoSanoConsultorio", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_ControlNiñoSanoConsultorio",schema);
			}
		}
		#endregion
		...
		private DalSic.AprRelControlNiñoSanoFactorRiesgoCollection colAprRelControlNiñoSanoFactorRiesgoRecords;
		public DalSic.AprRelControlNiñoSanoFactorRiesgoCollection AprRelControlNiñoSanoFactorRiesgoRecords
		{
			get
			{
				if(colAprRelControlNiñoSanoFactorRiesgoRecords == null)
				{
					colAprRelControlNiñoSanoFactorRiesgoRecords = new DalSic.AprRelControlNiñoSanoFactorRiesgoCollection().Where(AprRelControlNiñoSanoFactorRiesgo.Columns.IdControlNiñoSanoConsultorio, IdControlNiñoSanoConsultorio).Load();
			...
			set 
			{ 
					colAprRelControlNiñoSanoFactorRiesgoRecords = value; 
					colAprRelControlNiñoSanoFactorRiesgoRecords.ListChanged += new ListChangedEventHandler(colAprRelControlNiñoSanoFactorRiesgoRecords_ListChanged);
			}
		}
		...
		private DalSic.AprRelControNiñoSanoFactorProtectorCollection colAprRelControNiñoSanoFactorProtectorRecords;
		public DalSic.AprRelControNiñoSanoFactorProtectorCollection AprRelControNiñoSanoFactorProtectorRecords
		{
			get
			{
				if(colAprRelControNiñoSanoFactorProtectorRecords == null)
				{
					colAprRelControNiñoSanoFactorProtectorRecords = new DalSic.AprRelControNiñoSanoFactorProtectorCollection().Where(AprRelControNiñoSanoFactorProtector.Columns.IdControlNiñoSanoConsultorio, IdControlNiñoSanoConsultorio).Load();
			...
			set 
			{ 
					colAprRelControNiñoSanoFactorProtectorRecords = value; 
					colAprRelControNiñoSanoFactorProtectorRecords.ListChanged += new ListChangedEventHandler(colAprRelControNiñoSanoFactorProtectorRecords_ListChanged);
			}
		}
		...
		private DalSic.AprRelControlNiñoSanoAreaDesarrolloCollection colAprRelControlNiñoSanoAreaDesarrolloRecords;
		public DalSic.AprRelControlNiñoSanoAreaDesarrolloCollection AprRelControlNiñoSanoAreaDesarrolloRecords
		{
			get
			{
				if(colAprRelControlNiñoSanoAreaDesarrolloRecords == null)
				{
					colAprRelControlNiñoSanoAreaDesarrolloRecords = new DalSic.AprRelControlNiñoSanoAreaDesarrolloCollection().Where(AprRelControlNiñoSanoAreaDesarrollo.Columns.IdControlNiñoSanoConsultorio, IdControlNiñoSanoConsultorio).Load();
			...
			set 
			{ 
					colAprRelControlNiñoSanoAreaDesarrolloRecords = value; 
					colAprRelControlNiñoSanoAreaDesarrolloRecords.ListChanged += new ListChangedEventHandler(colAprRelControlNiñoSanoAreaDesarrolloRecords_ListChanged);
			}
		}
		...
		/// 
		/// </summary>
		public DalSic.AprTipoLactancium AprTipoLactancium
		{
			get { return DalSic.AprTipoLactancium.FetchByID(this.IdTipoLactancia); }
		...
		/// 
		/// </summary>
		public DalSic.AprControlNiñoSano AprControlNiñoSano
		{
			get { return DalSic.AprControlNiñoSano.FetchByID(this.IdControlNiñoSano); }
		...
		/// 
		/// </summary>
		public DalSic.AprIntervencion AprIntervencion
		{
			get { return DalSic.AprIntervencion.FetchByID(this.IdIntervencion); }
        ...
        public void SetPKValues()
        {
                if (colAprRelControlNiñoSanoFactorRiesgoRecords != null)
                {
                    foreach (DalSic.AprRelControlNiñoSanoFactorRiesgo item in colAprRelControlNiñoSanoFactorRiesgoRecords)
                    {
                ...
                if (colAprRelControNiñoSanoFactorProtectorRecords != null)
                {
                    foreach (DalSic.AprRelControNiñoSanoFactorProtector item in colAprRelControNiñoSanoFactorProtectorRecords)
                    {
                        if (item.IdControlNiñoSanoConsultorio != IdControlNiñoSanoConsultorio)
                        {
                            item.IdControlNiñoSanoConsultorio = IdControlNiñoSanoConsultorio;
                ...
                if (colAprRelControlNiñoSanoAreaDesarrolloRecords != null)
                {
                    foreach (DalSic.AprRelControlNiñoSanoAreaDesarrollo item in colAprRelControlNiñoSanoAreaDesarrolloRecords)
                    {
                        if (item.IdControlNiñoSanoConsultorio != IdControlNiñoSanoConsultorio)
                        {
                            item.IdControlNiñoSanoConsultorio = IdControlNiñoSanoConsultorio;
