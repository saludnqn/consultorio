...
namespace DalSic
{
	...
	public partial class PnClasificacionManual : ActiveRecord<PnClasificacionManual>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PN_clasificacion_manual", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("PN_clasificacion_manual",schema);
			}
		}
		#endregion
