...
namespace DalSic
{
	...
	public partial class AprPercentilesIMCEdad : ActiveRecord<AprPercentilesIMCEdad>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_PercentilesIMCEdad", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_PercentilesIMCEdad",schema);
			}
		}
		#endregion
