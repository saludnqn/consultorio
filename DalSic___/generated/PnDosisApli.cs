...
namespace DalSic
{
	...
	public partial class PnDosisApli : ActiveRecord<PnDosisApli>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PN_dosis_apli", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("PN_dosis_apli",schema);
			}
		}
		#endregion
