...
namespace DalSic
{
	...
	public partial class SysIdioma : ActiveRecord<SysIdioma>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Idioma", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("Sys_Idioma",schema);
			}
		}
		#endregion
