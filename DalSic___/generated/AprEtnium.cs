...
namespace DalSic
{
	...
	public partial class AprEtnium : ActiveRecord<AprEtnium>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_Etnia", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_Etnia",schema);
			}
		}
		#endregion
