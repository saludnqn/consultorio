...
namespace DalSic{
    ...
    public partial class ConCantidadTurnosDadosAnticipado : ReadOnlyRecord<ConCantidadTurnosDadosAnticipado>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadTurnosDadosAnticipados", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_CantidadTurnosDadosAnticipados",schema);
            }
        }
        #endregion
