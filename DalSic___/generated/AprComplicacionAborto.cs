...
namespace DalSic
{
	...
	public partial class AprComplicacionAborto : ActiveRecord<AprComplicacionAborto>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ComplicacionAborto", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_ComplicacionAborto",schema);
			}
		}
		#endregion
