...
namespace DalSic
{
	...
	public partial class AprControlOdontologico : ActiveRecord<AprControlOdontologico>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ControlOdontologico", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_ControlOdontologico",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Insert(int varIdHistoriaClinicaPerinatal,int varIdEfector,DateTime? varFecha,string varMotivo,string varDescripcion,int varIdProfesional,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
		...
		/// </summary>
		public static void Update(int varIdControlOdontologico,int varIdHistoriaClinicaPerinatal,int varIdEfector,DateTime? varFecha,string varMotivo,string varDescripcion,int varIdProfesional,string varCreatedBy,DateTime? varCreatedOn,string varModifiedBy,DateTime? varModifiedOn)
		{
			AprControlOdontologico item = new AprControlOdontologico();
