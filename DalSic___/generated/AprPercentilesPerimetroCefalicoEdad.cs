...
namespace DalSic
{
	...
	public partial class AprPercentilesPerimetroCefalicoEdad : ActiveRecord<AprPercentilesPerimetroCefalicoEdad>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_PercentilesPerimetroCefalicoEdad", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_PercentilesPerimetroCefalicoEdad",schema);
			}
		}
		#endregion
