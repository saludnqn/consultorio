...
namespace DalSic{
    ...
    public partial class VwAspnetUser : ReadOnlyRecord<VwAspnetUser>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("vw_aspnet_Users", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("vw_aspnet_Users",schema);
            }
        }
        #endregion
