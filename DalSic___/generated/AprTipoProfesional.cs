...
namespace DalSic
{
	...
	public partial class AprTipoProfesional : ActiveRecord<AprTipoProfesional>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_TipoProfesional", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_TipoProfesional",schema);
			}
		}
		#endregion
