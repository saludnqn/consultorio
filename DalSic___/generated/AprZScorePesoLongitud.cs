...
namespace DalSic
{
	...
	public partial class AprZScorePesoLongitud : ActiveRecord<AprZScorePesoLongitud>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ZScorePesoLongitud", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_ZScorePesoLongitud",schema);
			}
		}
		#endregion
