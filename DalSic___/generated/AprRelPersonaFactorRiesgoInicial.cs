...
namespace DalSic
{
	...
	public partial class AprRelPersonaFactorRiesgoInicial : ActiveRecord<AprRelPersonaFactorRiesgoInicial>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_RelPersonaFactorRiesgoInicial", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_RelPersonaFactorRiesgoInicial",schema);
			}
		}
		#endregion
