...
namespace DalSic
{
	...
	public partial class AprNumeroDosi : ActiveRecord<AprNumeroDosi>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_NumeroDosis", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_NumeroDosis",schema);
			}
		}
		#endregion
		...
		public DalSic.AprCalendarioVacunaCollection AprCalendarioVacunaRecords
		{
			get
			{
				...
				{
					colAprCalendarioVacunaRecords = new DalSic.AprCalendarioVacunaCollection().Where(AprCalendarioVacuna.Columns.IdNumeroDosis, IdNumeroDosis).Load();
