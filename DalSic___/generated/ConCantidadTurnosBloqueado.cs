...
namespace DalSic{
    ...
    public partial class ConCantidadTurnosBloqueado : ReadOnlyRecord<ConCantidadTurnosBloqueado>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadTurnosBloqueados", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_CantidadTurnosBloqueados",schema);
            }
        }
        #endregion
