...
namespace DalSic{
    ...
    public partial class ConCantidadSobreTurno : ReadOnlyRecord<ConCantidadSobreTurno>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadSobreTurnos", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_CantidadSobreTurnos",schema);
            }
        }
        #endregion
