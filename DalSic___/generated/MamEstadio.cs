...
{
	/// <summary>
	/// Strongly-typed collection for the MamEstadio class.
	/// </summary>
    [Serializable]
	public partial class MamEstadioCollection : ActiveList<MamEstadio, MamEstadioCollection>
	{	   
		public MamEstadioCollection() {}
        
        /// <summary>
		/// Filters an existing collection based on the set criteria. This is an in-memory filter
		/// Thanks to developingchris for this!
        /// </summary>
        /// <returns>MamEstadioCollection</returns>
		public MamEstadioCollection Filter()
        {
	...
	/// <summary>
	/// This is an ActiveRecord class which wraps the MAM_Estadio table.
	/// </summary>
	[Serializable]
	public partial class MamEstadio : ActiveRecord<MamEstadio>, IActiveRecord
	{
		...
		public MamEstadio(bool useDatabaseDefaults)
		{
			SetSQLProps();
		...
		public MamEstadio(object keyID)
		{
			SetSQLProps();
			InitSetDefaults();
			LoadByKey(keyID);
		...
		public MamEstadio(string columnName, object columnValue)
		{
			SetSQLProps();
			InitSetDefaults();
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("MAM_Estadio", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("MAM_Estadio",schema);
			}
		}
		#endregion
		...
		/// </summary>
		public static void Update(int varIdEstadio,string varDescripcion)
		{
			MamEstadio item = new MamEstadio();
