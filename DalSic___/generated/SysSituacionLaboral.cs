...
namespace DalSic
{
	...
	public partial class SysSituacionLaboral : ActiveRecord<SysSituacionLaboral>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_SituacionLaboral", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("Sys_SituacionLaboral",schema);
			}
		}
		#endregion
		...
		public DalSic.SysParentescoCollection SysParentescoRecords
		{
			get
			{
				...
				{
					colSysParentescoRecords = new DalSic.SysParentescoCollection().Where(SysParentesco.Columns.IdSituacionLaboral, IdSituacionLaboral).Load();
