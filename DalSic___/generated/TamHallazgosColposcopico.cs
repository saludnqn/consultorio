...
namespace DalSic
{
	...
	public partial class TamHallazgosColposcopico : ActiveRecord<TamHallazgosColposcopico>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("TAM_HallazgosColposcopicos", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("TAM_HallazgosColposcopicos",schema);
			}
		}
		#endregion
