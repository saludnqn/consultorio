...
namespace DalSic
{
	...
	public partial class AprActividad : ActiveRecord<AprActividad>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_Actividad", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_Actividad",schema);
			}
		}
		#endregion
		...
		public DalSic.AprIntervencionProfesionalCollection AprIntervencionProfesionalRecords
		{
			get
			{
				...
				{
					colAprIntervencionProfesionalRecords = new DalSic.AprIntervencionProfesionalCollection().Where(AprIntervencionProfesional.Columns.IdActividad, IdActividad).Load();
