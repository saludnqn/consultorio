...
namespace DalSic{
    ...
    public partial class ConCantidadTurnosAusente : ReadOnlyRecord<ConCantidadTurnosAusente>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadTurnosAusentes", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_CantidadTurnosAusentes",schema);
            }
        }
        #endregion
