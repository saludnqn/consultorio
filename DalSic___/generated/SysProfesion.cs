...
namespace DalSic
{
	...
	public partial class SysProfesion : ActiveRecord<SysProfesion>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("Sys_Profesion", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("Sys_Profesion",schema);
			}
		}
		#endregion
		...
		public DalSic.SysParentescoCollection SysParentescoRecords
		{
			get
			{
				...
				{
					colSysParentescoRecords = new DalSic.SysParentescoCollection().Where(SysParentesco.Columns.IdProfesion, IdProfesion).Load();
