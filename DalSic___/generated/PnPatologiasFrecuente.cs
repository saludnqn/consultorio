...
namespace DalSic
{
	...
	public partial class PnPatologiasFrecuente : ActiveRecord<PnPatologiasFrecuente>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("PN_patologias_frecuentes", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("PN_patologias_frecuentes",schema);
			}
		}
		#endregion
