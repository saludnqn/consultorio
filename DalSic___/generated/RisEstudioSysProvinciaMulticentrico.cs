...
namespace DalSic
{
	...
	public partial class RisEstudioSysProvinciaMulticentrico : ActiveRecord<RisEstudioSysProvinciaMulticentrico>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RIS_EstudioSysProvinciaMulticentrico", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("RIS_EstudioSysProvinciaMulticentrico",schema);
			}
		}
		#endregion
