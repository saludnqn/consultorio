...
namespace DalSic{
    ...
    public partial class ConTurnosAnticipadosAusente : ReadOnlyRecord<ConTurnosAnticipadosAusente>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_TurnosAnticipadosAusentes", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_TurnosAnticipadosAusentes",schema);
            }
        }
        #endregion
