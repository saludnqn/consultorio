...
namespace DalSic{
    ...
    public partial class ConCantidadTurnosDado : ReadOnlyRecord<ConCantidadTurnosDado>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_CantidadTurnosDados", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_CantidadTurnosDados",schema);
            }
        }
        #endregion
