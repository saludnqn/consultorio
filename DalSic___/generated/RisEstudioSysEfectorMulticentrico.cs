...
namespace DalSic
{
	...
	public partial class RisEstudioSysEfectorMulticentrico : ActiveRecord<RisEstudioSysEfectorMulticentrico>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("RIS_EstudioSysEfectorMulticentrico", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("RIS_EstudioSysEfectorMulticentrico",schema);
			}
		}
		#endregion
