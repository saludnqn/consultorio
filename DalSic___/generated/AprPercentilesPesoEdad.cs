...
namespace DalSic
{
	...
	public partial class AprPercentilesPesoEdad : ActiveRecord<AprPercentilesPesoEdad>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_PercentilesPesoEdad", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_PercentilesPesoEdad",schema);
			}
		}
		#endregion
