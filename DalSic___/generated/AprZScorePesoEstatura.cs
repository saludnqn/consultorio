...
namespace DalSic
{
	...
	public partial class AprZScorePesoEstatura : ActiveRecord<AprZScorePesoEstatura>, IActiveRecord
	{
		...
		private static void GetTableSchema() 
		{
			...
			{
				//Schema declaration
				TableSchema.Table schema = new TableSchema.Table("APR_ZScorePesoEstatura", TableType.Table, DataService.GetInstance("sicProvider"));
				...
				DataService.Providers["sicProvider"].AddSchema("APR_ZScorePesoEstatura",schema);
			}
		}
		#endregion
