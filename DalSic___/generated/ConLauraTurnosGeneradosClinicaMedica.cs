...
namespace DalSic{
    ...
    public partial class ConLauraTurnosGeneradosClinicaMedica : ReadOnlyRecord<ConLauraTurnosGeneradosClinicaMedica>, IReadOnlyRecord
    {
        ...
        private static void GetTableSchema() 
        {
            ...
            {
                //Schema declaration
                TableSchema.Table schema = new TableSchema.Table("CON_laura_turnosGeneradosClinicaMedica", TableType.View, DataService.GetInstance("sicProvider"));
                ...
                DataService.Providers["sicProvider"].AddSchema("CON_laura_turnosGeneradosClinicaMedica",schema);
            }
        }
        #endregion
